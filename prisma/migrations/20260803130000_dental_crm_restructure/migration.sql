-- Restructurare CRM laborator dentar: tabele noi, date vechi de test eliminate.
PRAGMA foreign_keys=OFF;

DROP TABLE IF EXISTS "WorkMaterial";
DROP TABLE IF EXISTS "CostEntry";
DROP TABLE IF EXISTS "SalaryEntry";
